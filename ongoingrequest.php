	...
	<!-- =========================================================== -->		
		...
		<div class="container-fluid">			
			...
			<div class="page-header">
				<h1>On Going Service Request</h1>
				<ul class="breadcrumbs">
					<li>Pages</li>
					<li>On Going Request</li>
				</ul>
			</div>			
				...
				<!-- <section class="col-aside col-right dark-bg clearfix pb20">
					<form id="filterTickets">
						<div class="p20 pt30">
							...
							<select id="filterOn Going" class="selectpicker mt20" data-width="90%">
								<option value="">On Going All</option>
