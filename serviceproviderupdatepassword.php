				...
				<section class="col-content helpdesk-content">
					<div class="col-sm-8 col-sm-offset-2">
						...
						<div class="row">
							...
							<div class="form-group input-field label-float mr10">
								<i class="mdi mdi-key prefix"></i>
								<label class="" for="exampleInputPassword2">New Password</label>
					...
					<div class="row">
							...
							<div class="form-group input-field label-float mr10">
								<i class="mdi mdi-key prefix"></i>
								<label class="" for="exampleInputPassword3">Confirm Password</label>
								<input type="password" id="exampleInputPassword3">
								<div class="input-highlight"></div>
							</div>
						</div>
						<div class="col-md-2">
					...
					<div class="row">
						<div class="form-group pull-right">
								<button type="submit" class="btn theme-accent mt30 
								">Change<i class="mdi mdi-send right"></i></button>
							</div>
					</div>
						</form>
					</div>
