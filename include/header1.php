	...
	<header class="header-bar toggler-hide theme">	
		<div class="toolbar">
			...
			<div class="pull-right search-wrapper">
				...
				<a  class="icon action mdi dropdown-toggle mdi-settings" data-toggle="dropdown"></a>
				<ul class="dropdown-menu">
			                    ...
			                    <li>
		                            <a href="serviceproviderupdatepassword.php">Change Password</a>
		                        </li>
			...
			<div class="title brand-name"><a href="providerDashboard.php"><img src="images/logo.png" style="height: 45px;"></a></div>
		</div><!-- /.toolbar -->
	</header>