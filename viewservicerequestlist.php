						...
						<table id="ticketsTable" class="table-hover">
							<thead>
								<tr>
									...
									<th class="sort" data-sort="due-date">Status</th>
									<th class="sort" data-sort="due-date">View</th>
							...
							<tbody class="list">
								<tr>
                                    ...
                                    <td class="due-date">
										<div class="btn-group">					
											 <a href="assetservicedetail.php" class="btn theme waves-effect waves-light"><i class="fa fa-info"></i></a>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
                                       <div class="dropdown">
                                        <button class="btn theme  waves-effect waves-light" dropdown-toggle"="" type="button" data-toggle="dropdown">New
                                       <!-- <span class="caret"></span></button> -->
