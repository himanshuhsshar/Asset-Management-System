					...
					<form id="filterTickets">
						<div class="p20 pt30">
							...
							<select id="filterAgents" class="selectpicker mt30" data-width="90%">
								...
								<option value="Steve Johnson">Gaming </option>
								<option value="Denise Williams">Electronics</option>
							...
							<select id="filterPriority" class="selectpicker mt20" data-width="90%">
								...
								<option value="high">Lenevo</option>
								<option value="normal">Sony</option>
						...
						<table id="ticketsTable" class="table-hover">
							<thead>
								<tr>
									...
									<th class="sort" data-sort="priority">Manufacture</th>
							...
							<tbody class="list">
								<tr>
									...
									<td class="due-date">
										<div class="btn-group">					
											<a href="#!" class="btn blue waves-effect waves-light"><i class="fa fa-edit"></i></a>
