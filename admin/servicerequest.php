				...
				<section class="col-content ticket-content pt10 pb20">
					...
					<div class="table-responsive table-wrapper">
						<table id="ticketsTable" class="table-hover">
							...
							<tbody class="list">
								<tr>
									<td class="id"><a href="detailedservicerequest.php">Not Working</a></td>
									...
									<td>
                                       <div class="dropdown">
                                        <button class="btn amber waves-effect waves-light" dropdown-toggle" type="button" data-toggle="dropdown">Status
