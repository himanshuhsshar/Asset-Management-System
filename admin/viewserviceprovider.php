	...
	<!-- =========================================================== -->		
		...
		<div class="container-fluid">			
			...
			<div class="page-header">
				<h1>View Service Provider List</h1>
				<ul class="breadcrumbs">
					<li>Pages</li>
					<li>View Service Provider List</li>
				</ul>
			</div>			
					...
					<div class="toolbar mb20">
						...
						<div class="pull-right mr12">
							<div class="input-field hidden-xs pull-left">
								...
								<input id="filter_tickets" class="search" type="text" placeholder="Search Service Provider">
						...
						<table id="ticketsTable" class="table-hover">
							<thead>
								<tr>
									...
									<!--<th class="sort" data-sort="due-date">Closed Service Request</th>
									<th class="sort" data-sort="due-date">Ongoing Service Request</th>
									<th class="sort" data-sort="due-date">New Service Request</th>-->
									<th class="sort" data-sort="due-date">Action</th>
								</tr>
							</thead>
							<tbody class="list">
								<tr>
									<td class="id"><a href="editserviceproviderprofile.php">16568</a></td>
									...
									<td class="due-date">
										<div class="btn-group">					
											<a href="editserviceproviderprofile.php" class="btn  blue waves-effect waves-light"><i class="fa fa-edit"></i></a>
