<div id="whiteModal" class="modal modal-white" tabindex="-1" role="dialog">
							<div class="modal-dialog modal-lg" role="document">
						    	<div class="modal-content">
									<div class="modal-header theme">
										<button type="button" class="btn-close modal-close" data-dismiss="modal" aria-label="Close"></button>
										<h1 class="text-display-2">Post Request To Service Provider</h1>
									</div><!-- /.modal-header -->
...
<!-- C3 Chart d3 script must be loaded before c3 -->
<script src="dist/js/plugins/d3/d3.min.js"></script>
<script src="dist/js/plugins/c3/c3.min.js"></script>

<!-- Flot chart -->
<!-- <script src="dist/js/plugins/flot/jquery.flot.min.js"></script> -->
<!-- <script src="dist/js/plugins/flot/jquery.flot.resize.min.js"></script> -->
<!-- <script src="dist/js/plugins/flot/jquery.flot.pie.min.js"></script> -->

<!-- justgage uses raphael.js -->
<script src="dist/js/plugins/gauge/raphael-2.1.4.min.js"></script>
<script src="dist/js/plugins/gauge/justgage.js"></script>

<script src="dist/js/plugins/progressbar/progressbar.min.js"></script>

<!-- app -->
<script src="dist/js/app.js"></script>
<script src="dist/js/plugins/smoothscroll/smooth-scroll.js"></script>

<!-- <script src="demo/demo-helpdesk.js"></script> -->
<script src="demo/demo-c3.js"></script>
