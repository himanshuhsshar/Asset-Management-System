	...
	<!-- =========================================================== -->		
		...
		<div class="container-fluid">			
			...
			<div class="page-header">
				<h1>Delayed Service Request</h1>
				<ul class="breadcrumbs">
					<li>Pages</li>
					<li>Delayed Service Request</li>
				</ul>
			</div>			
						...
						<table id="ticketsTable" class="table-hover">
							...
							<tbody class="list">
								<tr>
									...
									<td>
                                       <div class="dropdown">
                                        <button class="btn theme  waves-effect waves-light" dropdown-toggle"="" type="button" data-toggle="dropdown">Delayed
